var scene, camera, renderer, venusMesh, light, light2, light3;

var rotationFlag = true;
var stars, particle;

var textureVenus = new THREE.TextureLoader().load("textures/venus/venusmap.jpg");
var textureShadow = new THREE.TextureLoader().load("textures/venus/venusbump.jpg");

var angle = (Math.PI * 2.64) / 180;
...
if ( rotationFlag )
	{
   venusMesh.rotation.y -=  0.002; //escala n/1 em km/s
	}
