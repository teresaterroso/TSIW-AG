var scene, camera, renderer, mercuryMesh, light, light2, light3;

var rotationFlag = true;
var stars, particle;

var textureMercury = new THREE.TextureLoader().load("textures/mercury/mercurymap.jpg");
var textureShadow = new THREE.TextureLoader().load("textures/mercury/mercurybump.jpg");

var angle = (Math.PI * 0.03) / 180;
...
if ( rotationFlag )
	{
   mercuryMesh.rotation.y += 0.003; //escala n/1 em km/s
	}
