var scene, camera, renderer, saturnMesh, light, light2, light3, ringMesh, pivotPoint;

var rotationFlag = true;
var stars, particle;

var textureSaturn = new THREE.TextureLoader().load("textures/saturn/saturnmap.jpg");
var textureShadow = new THREE.TextureLoader().load("textures/saturn/saturnbump.jpg");
var textureRing = new THREE.TextureLoader().load("textures/saturn/saturnringcolor.png");
var textureRingTransparency = new THREE.TextureLoader().load("textures/saturn/saturnringtransparencymap.png");

var angle = (Math.PI * 26.73) / 180;
...
function render() {
	...
	if ( rotationFlag )
	{
	saturnMesh.rotation.y +=  0.00987; //escala n/1000 em km/s
	}
