var scene, camera, renderer, plutoMesh, light, light2, light3;

var rotationFlag = true;
var stars, particle;

var texturePluto = new THREE.TextureLoader().load("textures/pluto/plutomap.jpg");
var textureShadow = new THREE.TextureLoader().load("textures/pluto/plutobump.jpg");

var angle = (Math.PI * 57.47) / 180;
...
var material  = new THREE.MeshPhongMaterial( {wireframe: false,
                                             ...
                                             bumpScale: 0.01});
plutoMesh = new THREE.Mesh(geometry, material);
plutoPivot.add(plutoMesh);
plutoPivot.rotation.z=angle;
...
if ( rotationFlag )
	{
   plutoMesh.rotation.y -= 0.0012; //escala n/10 em km/s
	}
